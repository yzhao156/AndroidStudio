...
public class ServiceProviderSignUpActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_provider_sign_up3);
        resetArray();
        resetListView();
    }
                ...
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {//position is the item be clicked's position
                        ...
                        if (flag){
                            ...
                            Toast.makeText(ServiceProviderSignUpActivity3.this, "Added " + " unsuccessfully, already added.", Toast.LENGTH_LONG).show();
    ...
    public void psu3(View view){
        MainActivity.spp.setRateNumber(0);
        MainActivity.spp.setCurrentRate(0.0);
        serviceProviderProfileRef.child(MainActivity.spp.getUserName()).setValue(MainActivity.spp);


        Toast.makeText(ServiceProviderSignUpActivity3.this, "Added " + " successfully.", Toast.LENGTH_LONG).show();
        Intent intent = new Intent(getApplicationContext(),ServiceProviderSpecifyAvailability.class);
